...
def main():
    ...
    save_images_per_class(50, train_loader,class_names, 'real_data_balanced')
    ...
    train_loader = create_balanced_dataloader(train_loader, 390)
    ...
    for exp in range(len(ipc_trys)):
        ...
        save_images_per_class(ipc, trainloader, class_names, 'syn_data_balanced')
    ...
    df.to_csv('DM_without_DSA_balanced.csv', index=False)
